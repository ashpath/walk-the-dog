...
help_topics = {
    ...
    "leash": "With Argument of either dog or dog's name, you clip the leash on and it follows. Arg off stops your dog "
    "from following you, but due to local bylaws you can only do this in your house.",
