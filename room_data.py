...
room_descriptions = {
    ...
    "bathroom1": "This is a bathroom. There is a bathtub, a sink, a toilet and a showerhead here.",
    ...
    "hall4": "You are standing in a hallway. Your living room is to the west. A kitchen is northward. There isn't much "
             "here to look at.",
...
#Data about objects you can interact with in rooms. Some objects you can pick up and hold.
room_articles = {
    "bedroom": {
    ...
    "closet": {
        ...
        "hatch": "This lets you go up to the attic. You don't really want to go up there right now, its all spiderwebs "
                 "and junk.",
    ...
    "kitchen": {
        ...
        "blender": "This appliance turns most things inserted within into a mass of goo. Sometimes it's delicious goo, "
